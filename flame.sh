...
GAS_METERING=1 sudo flamegraph -o flamegraph_g2_const.svg ./target/release/eth_pairings-910093209ca7540b --nocapture flame_one_off_field_and_curve_constuction_g2_ext3
