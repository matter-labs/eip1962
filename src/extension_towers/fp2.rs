...
pub struct Fp2<'a, E: ElementRepr, F: SizedPrimeField<Repr = E> >{
    pub c0: PrimeFieldElement<'a, E, F>,
    pub c1: PrimeFieldElement<'a, E, F>,
...
impl<'a, E: ElementRepr, F: SizedPrimeField<Repr = E> > ExtensionFieldElement for Fp2<'a, E, F> {
...
pub struct Extension2<'a, E: ElementRepr, F: SizedPrimeField<Repr = E> > {
    pub non_residue_c0: PrimeFieldElement<'a, E, F>,
    pub non_residue_c1: PrimeFieldElement<'a, E, F>,
    pub field: &'a F
}
