...
mod tests {
    ...
    use num_traits::Num;
    use crate::weierstrass::{CurveParameters, CurveOverFpParameters, CurveOverFp3Parameters};
    ...
    fn test_mnt6_pairing() {
        ...
        let curve_twist = WeierstrassCurve::new(group_order.clone(), a_fp3, b_fp3, &fp3_params);
