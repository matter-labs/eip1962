macro_rules! expand_for_modulus_limbs {
    ($modulus_limbs: expr, $implementation: tt, $argument: expr, $func: tt, $scalar_repr: tt) => {
        match $modulus_limbs {
            4 => {
                $implementation::<U256Repr, $scalar_repr>::$func(&$argument)
            },
            5 => {
                $implementation::<U320Repr, $scalar_repr>::$func(&$argument)
            },
            6 => {
                $implementation::<U384Repr, $scalar_repr>::$func(&$argument)
            },
            7 => {
                $implementation::<U448Repr, $scalar_repr>::$func(&$argument)
            },
            8 => {
                $implementation::<U512Repr, $scalar_repr>::$func(&$argument)
            },
            9 => {
                $implementation::<U576Repr, $scalar_repr>::$func(&$argument)
            },
            10 => {
                $implementation::<U640Repr, $scalar_repr>::$func(&$argument)
            },
            11 => {
                $implementation::<U704Repr, $scalar_repr>::$func(&$argument)
            },
            12 => {
                $implementation::<U768Repr, $scalar_repr>::$func($argument)
            },
            13 => {
                $implementation::<U832Repr, $scalar_repr>::$func(&$argument)
            },
            14 => {
                $implementation::<U896Repr, $scalar_repr>::$func(&$argument)
            },
            15 => {
                $implementation::<U960Repr, $scalar_repr>::$func(&$argument)
            },
            16 => {
                $implementation::<U1024Repr, $scalar_repr>::$func($argument)
            },
